...
<div class="doc-grid">
  ...
  <div class="doc-card">
    <h3>覆盖真实附件场景</h3>
    <p>唯一目录注册 274 个扩展名和 47 条预览链路，其中 224 个稳定、50 个实验；覆盖 Office、Apple 文稿、PDF/OFD、工程、归档、媒体、代码、数据、可选 DICOM、数字签名与二进制检查格式。</p>
  </div>
  <div class="doc-card">
    <h3>模块化架构更专业</h3>
...
<div class="doc-grid">
  ...
  <div class="doc-card">
    <h3>确认格式边界</h3>
    <p>支持格式页列出 274 个已注册扩展名、47 条渲染链路、稳定/实验等级和真实业务边界。</p>
  </div>
  <div class="doc-card">
    <h3>选择接入方式</h3>
