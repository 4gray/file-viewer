export const site = {
  ...
  description:
    'Integrate File Viewer in browser applications with offline-first packages, on-demand renderers, self-hosting, and 274 registered file extensions.',
  descriptionZh:
    '在浏览器应用中集成 File Viewer，覆盖离线优先组件、按需渲染器、私有部署与 274 个已注册文件扩展名。',
} as const;
